...
MoonTv中收藏的是源，正常电影观看过程中，由于源的不稳定，经常需要切换源，当源切换后，之前的收藏就需要删除，然后重新收藏源，非常的麻烦。

本APP从1.3.22版本开始，收藏数据不兼容MoonTv格式，在本APP中收藏的视频无法在MoonTv网站中打开，其它功能不影响兼容性。

通过本APP收藏的电影，可以任意的切换源，无需重新收藏即可在收藏界面中打开最新观看的源。

如在安装1.3.22版本前已经有收藏数据，需要先通过MoonTv站点清空收藏，然后重新在本APP中收藏，方可正常使用。
